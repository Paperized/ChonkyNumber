...
* [Usage](#usage)
  ...
  * [Mathematical Operator Overload](#mathematical-operator-overload)
...
### Logging
If you would like some logs on the console when you perform an illegal operation like dividing by 0 or 0 pow of 0 you can add a **preprocessor macro**
It might be used in the future for other logging purpose.

    DEBUG_IRREGULAR_OPERATIONS;
